...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cellconstructor-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cellconstructor-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cellconstructor
# for installing globally
pixi global install cellconstructor
```
...
It is possible to list all of the versions of `cellconstructor` available on your platform:
...
```
pixi search cellconstructor --channel conda-forge
```
